...
def volumetric_flow_rate(*, v_wind, hole_area):
    return v_wind*hole_area


# heat generated by air
def get_heat_air(*, specific_heat, volume, density, temp_target, temp_now):
    delta_temp = abs(temp_target - temp_now)
    heat = specific_heat*density*volume*delta_temp
    return heat
